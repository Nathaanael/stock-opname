...
class MenuHelper
{
        ...
        $roleMenus = match ($role) {
            'owner' => [
                ...
                [
                    'icon' => 'tables',
                    'name' => 'Master Barang',
                    'path' => '/admin-gudang/items',
                ],
                [
                    'icon' => 'inbound',
                    'name' => 'Barang Masuk',
                    'path' => '/admin-gudang/inbound',
                ],
                [
                    'icon' => 'outbound',
                    'name' => 'Barang Keluar',
                    'path' => '/admin-gudang/outbound',
                ],
                [
                    'icon' => 'stockopname',
                    'name' => 'Stock Opname',
                    'path' => '/admin-gudang/stock-opname',
                ],
                [
                    'icon' => 'user-profile',
                    'name' => 'User Profile',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'inbound' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="10" width="14" height="9" rx="1" stroke="currentColor" stroke-width="1.5"/><path d="M15 13L18 13L22 17V19H15V13Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><circle cx="5" cy="20" r="2" stroke="currentColor" stroke-width="1.5"/><circle cx="17" cy="20" r="2" stroke="currentColor" stroke-width="1.5"/><path d="M5 7V10M5 7L2 10M5 7L8 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'stockopname' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="18" height="21" rx="2" stroke="currentColor" stroke-width="1.5"/><rect x="8" y="1" width="8" height="4" rx="1.5" stroke="currentColor" stroke-width="1.5"/><polyline points="7,10 8.5,11.5 11,8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><polyline points="7,15 8.5,16.5 11,13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><line x1="7" y1="20" x2="11" y2="20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><rect x="13" y="14" width="8" height="8" rx="2" stroke="currentColor" stroke-width="1.5"/><line x1="15" y1="18" x2="19" y2="18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><line x1="17" y1="16" x2="17" y2="20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
            'outbound' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="10" width="14" height="9" rx="1" stroke="currentColor" stroke-width="1.5"/><path d="M15 13L18 13L22 17V19H15V13Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><circle cx="5" cy="20" r="2" stroke="currentColor" stroke-width="1.5"/><circle cx="17" cy="20" r="2" stroke="currentColor" stroke-width="1.5"/><path d="M5 3V6M5 3L2 6M5 3L8 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        ];
